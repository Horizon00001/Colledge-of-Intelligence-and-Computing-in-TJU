...
with open('Python\自动学生成绩查询\学号.txt', 'r', encoding='utf-8') as ifile:
    for line in ifile:
...
with open('Python\自动学生成绩查询\学号转专业.txt', 'r', encoding='utf-8') as ifile2:
    for line in ifile2:
        l = line.split()  # 按空格分割每行
...
with open('Python\自动学生成绩查询\成绩.txt', 'a', encoding='utf-8') as f:
    f.write('学号,姓名,加权,排名' + '\n')  # 写入
